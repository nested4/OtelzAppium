...
public class OtelReservationUpdated {
    ...
    void reservation() throws MalformedURLException {
        ...
        caps.setCapability(MobileCapabilityType.APP, "C:\\Users\\ozgei\\IdeaProjects\\OtelzAppium\\src" +
                "\\test\\resources\\Otelz-dev.apk");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.otelz.mobil:id/search_src_text"))).
                sendKeys("Ankara");

        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("" +
                "(//*[@resource-id=\"com.otelz.mobil.search:id/tvSearchedItem\"])[1]"))).click();
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.
                xpath("//*[@resource-id=\"com.otelz.mobil:id/tv_day_number\" and @text=\"8\"]"))).click();

        driver.findElement(By.xpath("//*[@resource-id=\"com.otelz.mobil:id/tv_day_number\" and @text=\"10\"]"))
                .click();
        ...
        String expectedHotelPrice = driver.findElement(By.xpath("" +
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.otelz.mobil:id/tvPersonalInfoPhone"))).
                sendKeys("5555555555");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.otelz.mobil.reservationSteps:id/etCouponCode"))).
                sendKeys("APP05");
